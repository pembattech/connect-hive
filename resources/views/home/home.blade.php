<x-app-layout>
    <div class="first-page grid gap-10" style="grid-template-columns: 1fr 2fr 1fr;">
        ...
        <section class="right-wrapper position-sticky bg-white border-b border-gray-100 dark:border-gray-700">
            ...
            <button
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <line x1="12" y1="5" x2="12" y2="19" stroke="#0000FF" stroke-width="2"
                        stroke-linecap="round" />
                    <line x1="5" y1="12" x2="19" y2="12" stroke="#0000FF" stroke-width="2"
                        stroke-linecap="round" />
                </svg>
